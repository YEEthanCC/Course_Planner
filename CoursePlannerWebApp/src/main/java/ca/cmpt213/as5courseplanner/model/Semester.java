...
public class Semester implements Comparable<Semester> {
	...
	private static final String TERM_UNKNOWN = "(Other term)";
	...
	public String getTerm() {
		switch (getSemesterNumber()) {
			case SEMESTER_NUMBER_SPRING: return TERM_SPRING;
			case SEMESTER_NUMBER_SUMMER: return TERM_SUMMER;
			case SEMESTER_NUMBER_FALL:   return TERM_FALL;
			default:
				return TERM_UNKNOWN;
		}
	}
